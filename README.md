## Training
```bash
python3 train.py --task=robosuite_lift
```
...
- You may run into out-of-memory issues. For me with 32G ram, it happens at around 400k. See [this thread](https://github.com/facebookresearch/drqv2/issues/28). Make sure to set `replay_buffer_size` below what your ram can hold. 
